...
%
%
\textbf{TASK:} Recommend books (list of books) based on 1 book (opened book)
%
%
...
\clearpage
\subsection{Used Algorithms for Feature Extraction:}
\begin{enumerate}
\item TF-IDF
\item LSA
\item Word2Vec
...
%
%
\subsection{Used Similarity and Distance Measures:}
\begin{enumerate}
...
\subsection{Used Metrics for evaluation:}
\begin{itemize}
