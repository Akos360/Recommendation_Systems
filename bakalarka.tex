...
\documentclass[\myFontSize,oneside,english,hidelinks,a4paper]{book} 
\usepackage{graphicx}
\usepackage{float}
...
%
% LINKED OPEN DATA - CB and also KG
%
\textbf{Semantics}\\
There is a difference in Top-Down or Bottom-Up Semantics Approaches.\\\\
%
%
\textbf{Ontology}\\
...
\end{itemize}
%!!!!!!!!!!!!!!!!!!!!!!!!! scientific paper recommender systems - dobre rozpisane difficulties
